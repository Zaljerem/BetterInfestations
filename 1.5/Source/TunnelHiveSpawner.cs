...
namespace BetterInfestations
{
    ...
    public class TunnelHiveSpawner : ThingWithComps
    {
        ...
        public override void Tick()
        {
            ...
            if (Rand.MTBEventOccurs(FilthSpawnMTB, 1f, 1.TicksToSeconds()) && CellFinder.TryFindRandomReachableNearbyCell(Position, Map, FilthSpawnRadius, TraverseParms.For(TraverseMode.NoPassClosedDoors), null, null, out IntVec3 result))
            {
